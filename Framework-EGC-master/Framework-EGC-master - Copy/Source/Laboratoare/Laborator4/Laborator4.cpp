...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	*/
	int speed = 4;
	angularStepOY += deltaTimeSeconds * speed;
	angularStepOZ += deltaTimeSeconds * speed;
	angularStepOX += deltaTimeSeconds * speed;
	...
	modelMatrix *= Transform3D::Translate(0.0f, 0.0f, 1.4f);
	modelMatrix *= Transform3D::RotateOX(angularStepOX);
